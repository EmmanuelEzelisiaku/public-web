...
function ChatRoom() {
  ...
  const query = messagesRef.orderBy("createdAt").limit(1000000);
  ...
  return (
    <>
      ...
      <form onSubmit={sendMessage}>
        <i className='fa fa-camera btn' type='submit'></i>
      <button type="submit">gif</button>
        <input
        placeholder='type here'
          value={formValue}
          onChange={(e) => setFormValue(e.target.value)}
        />
        <i className='fa fa-camera btn'></i>
      </form>
    </>
  );
}
